...
export interface ApiTimeEntrieEventTimeEntrieEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'time_entrie_events';
  info: {
    displayName: 'time-entrie-event';
    pluralName: 'time-entrie-events';
    singularName: 'time-entrie-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::time-entrie-event.time-entrie-event'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    time_entrie: Schema.Attribute.Relation<
      'manyToOne',
      'api::time-entrie.time-entrie'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTimeEntrieTimeEntrie extends Struct.CollectionTypeSchema {
  collectionName: 'time_entries';
  info: {
    displayName: 'time-entrie';
    pluralName: 'time-entries';
    singularName: 'time-entrie';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    organization_member: Schema.Attribute.Relation<
      'manyToOne',
      'api::organization-member.organization-member'
    >;
    publishedAt: Schema.Attribute.DateTime;
    started_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    time_entrie_events: Schema.Attribute.Relation<
      'oneToMany',
      'api::time-entrie-event.time-entrie-event'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work_date: Schema.Attribute.Date;
  };
}
